...
import { Laptop2, ListMusicIcon, Mic2, Pause, Play, Repeat, Shuffle, SkipBack, SkipForward, Volume1 } from 'lucide-react';
			...
			<div className='flex justify-between items-center h-full max-w-[1800px] mx-auto'>
				...
				<div className='flex flex-col items-center gap-2 flex-1 max-w-full sm:max-w-[45%]'>
					...
					<div className='hidden sm:flex items-center gap-2 w-full'>
						...
						<Slider value={[currentTime]} max={duration || 100} step={1} className='w-full hover:cursor-pointer active:cursor-grabbing' onValueChange={handleSeek} />
				...
				<div className='hidden sm:flex items-center gap-4 min-w-[180px] w-[30%] justify-end'>
					...
					<div className='flex items-center gap-2'>
						...
						<Slider value={[volume]} max={100} step={1} className='w-24 hover:cursor-pointer active:cursor-grabbing' 
                            onValueChange={(value) => {
								setVolume(value[0]);
								if (audioRef.current) {
